...
namespace Tests
{
    ...
    public class WorkerTest
    {
        ...
        public void TestWorker()
        {
            ...
            ItemDescription id = new ItemDescription(57);
            DataSet second = new DataSet(2, Codes.CODE_CUSTOM, Codes.CODE_LIMITSET, 66, 66, EnteredData.full);
            id.DescriptionDataSet = second;
